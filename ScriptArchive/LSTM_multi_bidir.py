################################
# LSTM MULTIVARIATE BIDIRECTIONAL #
################################
...
X_train, y_train, model, history, X_test, y_test, model_eval, predictions, train_residuals, test_residuals = modeling_utilities.multi_bidir_LSTM_model(df_det_cor, df_anomaly, df_raw, time_steps, samples, cells, dropout, patience)
...
# Detect anomalies
test_score_array = modeling_utilities.detect_anomalies_bidir(df_det_cor, predictions, time_steps, test_residuals, threshold)
