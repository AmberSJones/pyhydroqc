...
#########################################
threshold = anomaly_utilities.set_dynamic_threshold(residuals[0], 30, 0.00001, 0.4)
...
# DETERMINE THRESHOLD AND DETECT ANOMALIES #
#########################################
threshold = anomaly_utilities.set_dynamic_threshold(residuals[0], 40, 0.000001, 5)
threshold.index = residuals.index
...
# DETERMINE THRESHOLD AND DETECT ANOMALIES #
#########################################
threshold = anomaly_utilities.set_dynamic_threshold(residuals[0], 20, 0.00001, 0.03)
threshold.index = residuals.index
...
# DETERMINE THRESHOLD AND DETECT ANOMALIES #
#########################################
threshold = anomaly_utilities.set_dynamic_threshold(residuals[0], 30, 0.00001, 0.25)
threshold.index = residuals.index
