...
plt.savefig('Examples/Plotting/Figures/Figure8.png', bbox_inches='tight')
...
plt.savefig('Examples/Plotting/Figures/FigureC5.png', bbox_inches='tight')


# figC5 = plt.figure(figsize=(10, 8))
#
# df = Mendon_cond
# df['corrected'] = np.where(np.isnan(df['forecasts']) & np.isnan(df['backcasts']), np.nan, df['det_cor'])
# observed = df['observed']
...
# ax.set_xlabel('Date')
#
# plt.savefig('Figures/FigureC5.png', bbox_inches='tight')
